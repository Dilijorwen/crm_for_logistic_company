...
import type { JsonHttpRequest, JsonHttpResponse, JsonHttpTransport } from './JsonHttpTransport';
...
export class FetchJsonTransport implements JsonHttpTransport {
  ...
  private async readBody(response: Response): Promise<unknown> {
    ...
    try {
      ...
      throw new RegistryError('INVALID_REGISTRY_RESPONSE', 'Registry returned invalid JSON.', false);
    }
  }
